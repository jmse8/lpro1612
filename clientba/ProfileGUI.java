...
import java.util.*;
/**
 * Interface gráfica para o perfil do utilizador.
 * @author lpro1612
 */
public class ProfileGUI extends javax.swing.JFrame {
    String username, name, email, gamesWon, gamesLost, hits;
    /**
    ...
    public ProfileGUI() {
        ...
        Profile perfil = new Profile(username);
        String dados[]=perfil.getInfo();
        
        name = dados[1] + " " + dados[2];
        email = dados[3];
        gamesWon = dados[4];
        gamesLost = dados[5];
        hits = dados[6];
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Nº of hits:");

        jLabel8.setText("Ranking Position:");
        ...
        jLabel12.setText(gamesWon);

        jLabel13.setText(gamesLost);

        jLabel14.setText(hits);
