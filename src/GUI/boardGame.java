...
public class boardGame extends javax.swing.JFrame {
    ...
    String username = "";
     ...
     AudioPlayer gameSound = new AudioPlayer();
    
    public void gameSound(){
        gameSound.getName("gameSound.wav");
        gameSound.soundBegin();
        gameSound.start();
        gameSound.loop();
    }
    ...
    public boardGame(int id) {
        ...
        if (input.get(0).equals(login.getUsername()))//0wner
        {
            ...
            play = "player1";
            int port = id + 1024;
            String[] out = {"sendOpponent", Integer.toString(id), login.getUsername()};
            p = new Protocol(1612);
            p.sendToServer(out);
            System.out.println("ENVIOU OPONENTE!");
            String[] out2 = {"sendUsername", player, login.getUsername()};
            p =new Protocol(port);
            p.sendToServer(out2);
        }
    ...
    public class OwnBoard extends JPanel {
            ...
            public void run() {
                ...
                while (!finish) {
                    ...
                    if (!"".equals(lastMove)) {
                        ...
                        if ("hit".equals(input.get(0))) {
                            getComponentAt(x * 40, y * 40).setBackground(Color.RED);
                        } else if ("miss".equals(input.get(0))) {
                            getComponentAt(x * 40, y * 40).setBackground(Color.BLUE);
        ...
        /**
         * Implementa, gráficamente, a mudança de cor das células na vertical a
         * partir da posição (x,y) em que o cursor se encontra.
         *
         * @param x Índice no eixo horizontal da célula onde o cursor se
         * encontra.
        ...
        /**
         * Implementa, gráficamente, a mudança de cor das células na horizontal
         * a partir da posição (x,y) em que o cursor se encontra.
         *
         * @param x Índice no eixo horizontal da célula onde o cursor se
         * encontra.
        ...
        /**
         * Implementa, graficamente, a mudança de cor das células, na vertical,
         * para a cor default do tabuleiro a partir da posição (x,y) onde o
         * cursor se encontra.
         *
         * @param x Índice no eixo horizontal da célula onde o cursor se
         * encontra.
        ...
        /**
         * Implementa, graficamente, a mudança de cor das células, na
         * horizontal, para a cor default do tabuleiro a partir da posição (x,y)
        ...
        public class CellPane extends JPanel {
            ...
            /**
             * Inicializa e constrói uma nova célula no tabuleiro na posição
             * (x,y).
             *
